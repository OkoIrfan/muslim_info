package com.okoirfan.user.sholatapp.ProdukHalal;
...
class ListProdukAdapter extends RecyclerView.Adapter<ListProdukAdapter.ProdukHolder>{
    private ArrayList<Produk> listProduk;
    public ListProdukAdapter(ArrayList<Produk> listProduk) {
        this.listProduk = listProduk;
    } @
            Override
    public ProdukHolder onCreateViewHolder(ViewGroup parent, int
            position) {
        LayoutInflater inflater =
                LayoutInflater.from(parent.getContext());
        return new ProdukHolder(inflater.inflate(R.layout.item_layout_halal, parent, false));
    } @
            Override
    public void onBindViewHolder(ProdukHolder produkHolder, int
            position) {
